...
if __name__ == "__main__":
    ...
    h7 = net.addDockerHost(
        "MB", dimage="my_dev_test", ip="10.0.0.7", mac="00:00:00:00:00:07", docker_args={"hostname":"MQTTbroker"}
    )
    h8 = net.addDockerHost(
        "MC", dimage="my_dev_test", ip="10.0.0.8", mac="00:00:00:00:00:08", docker_args={"hostname":"MQTTclient"}
    )
    h9 = net.addDockerHost(
        "WS", dimage="my_dev_test", ip="10.0.0.9", mac="00:00:00:00:00:09", docker_args={"hostname":"WebServer"}
    )
    ...
    print("*** Adding the Web server (my_dev_test for now)")
    srv8 = mgr.addContainer("srv8", "WS", "my_dev_test", "bash", docker_args={})
    
    print("*** Adding the MQTT Client (my_dev_test for now)")
    srv9 = mgr.addContainer("srv9", "MC", "my_dev_test", "bash", docker_args={})
