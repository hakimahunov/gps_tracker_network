...
#ovs-ofctl add-flow s1 dl_dst="ff:ff:ff:ff:ff:ff",actions=output:1
...
#ovs-ofctl add-flow s2 dl_dst="ff:ff:ff:ff:ff:ff",actions=output:1
...
#ovs-ofctl add-flow s3 dl_dst="ff:ff:ff:ff:ff:ff",actions=output:1
...
#ovs-ofctl add-flow s4 dl_dst="ff:ff:ff:ff:ff:ff",actions=output:1
ovs-ofctl add-flow s4 dl_src="00:00:00:00:00:07",dl_dst="00:00:00:00:00:08",actions=output:2
ovs-ofctl add-flow s4 dl_src="00:00:00:00:00:07",dl_dst="00:00:00:00:00:09",actions=output:2
